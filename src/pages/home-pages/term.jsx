      ...
      <div className="main-page-wrapper light-bg" id="home">
        ...
        <div className="privacy-policy container mt-150">
          <div>
            ...
            <div className="mt-30">Updated at 2023-01-17
            
            
            </div>
            <div className="mt-30">
              <h5 className="mb-30">General Terms</h5>
              <p>
                ...
                communication between you and Answergenie.
              </p>
              <p>
                Under no circumstances shall Answergenie team be liable for any
                ...
                site, even if Answergenie team or an authorized representative
              ...
              <p>
                Answergenie will not be responsible for any outcome that may
            ...
            <div className="mt-60">
              <h5 className="">License</h5>
              <p>
                Answergenie grants you a revocable, non-exclusive,
              ...
              <p>
                ...
                Terms & Conditions as the "Answergenie Service").
              </p>
              <p>
                ...
                Answergenie Service. In these Terms & Conditions, "you" refers
            ...
            <div className="mt-60">
              <h5>Meanings</h5>
              <div className="mt-30">For this Terms & Conditions:</div>
              <p>
              ...
              <p>
                {" "}
                -Country: where Answergenie or the owners/founders of
                Answergenie are based, in this case is India.
              </p>
              <p>
                {" "}
                -Device: any internet connected device such as a phone, tablet,
                computer or any other device that can be used to visit
                Answergenie and use the services.
              </p>
              <p>
                -Service: refers to the service provided by Answergenie as
              ...
              <p>
                {" "}
                -Website: Answergenie."’s" site, which can be accessed via this
                URL: <a>https://Answergenie.co/</a>
              </p>
              <p>
                -You: a person or entity that is registered with Answergenie to
                use the Services.
              </p>
            </div>
            <div className="mt-60">
              ...
              <p>
                ...
                notice of copyright or trademark) of Answergenie or its
            ...
            <div className="mt-60">
              ...
              <p>
                Thanks for shopping at Answergenie. We appreciate the fact that
              ...
              <p>
                ...
                that apply to transactions at Answergenie. We’ll be as brief as
                our attorneys will allow. The main thing to remember is that by
                placing an order or making a purchase at Answergenie, you agree
                to the terms along with Answergenie."’s" Privacy Policy.
              </p>
              <p>
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                (collectively, "Suggestions") provided by you to Answergenie
                with respect to the website shall remain the sole and exclusive
                property of Answergenie.
              </p>
              <p>
                Answergenie shall be free to use, copy, modify, publish, or
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                controlled by Answergenie. We are not responsible for the
            ...
            <div className="mt-60">
              ...
              <p>
                You acknowledge and agree that Answergenie may stop (permanently
                or temporarily) providing the Service (or any features within
                the Service) to you or to users generally at Answergenies sole
                discretion, without prior notice to you. You may stop using the
                Service at any time. You do not need to specifically inform
                Answergenie when you stop using the Service. You acknowledge and
                agree that if Answergenie disables access to your account, you
            ...
            <div className="mt-60">
              ...
              <p>
                Answergenie reserves the right to modify, suspend or
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                functionalities of the website. You agree that Answergenie has
            ...
            <div className="mt-60">
              ...
              <p>
                You acknowledge and agree that Answergenie shall not be
                ...
                thereof. Answergenie does not assume and shall not have any
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                from Answergenie, in the event that you fail to comply with any
              ...
              <p>
                ...
                Answergenie's rights or remedies at law or in equity in case of
            ...
            <div className="mt-60">
              ...
              <p>
                You agree to indemnify and hold Answergenie and its parents,
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                maximum extent permitted under applicable law, Answergenie, on
                ...
                practice. Without limitation to the foregoing, Answergenie
              ...
              <p>
                ...
                Answergenie's provider makes any representation or warranty of
                ...
                content, or e-mails sent from or on behalf of Answergenie are
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                liability of Answergenie and any of its suppliers under any
              ...
              <p>
                ...
                shall Answergenie or its suppliers be liable for any special,
                ...
                Agreement), even if Answergenie or any supplier has been advised
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                legal notices published by Answergenie on the Services, shall
                constitute the entire agreement between you and Answergenie
                ...
                term or any other term, and Answergenie."’s" failure to assert
                any right or provision under this Agreement shall not constitute
                a waiver of such right or provision. YOU AND Answergenie AGREE
            ...
            <div className="mt-60">
              ...
              <p>
                Answergenie reserves the right, at its sole discretion, to
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                when you use or purchase other Answergenie's services, which
                Answergenie will provide to you at the time of such use or
                purchase.
              </p>
            </div>
            <div className="mt-60">
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                Netherlands and international copyright, trademark, patent,
                ...
                part, without the express prior written permission of
                Answergenie, unless and except as is expressly provided in these
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                Answergenie."’s" INTELLECTUAL PROPERTY RIGHTS. The term
                “dispute” means any dispute, action, or other controversy
                between you and Answergenie concerning the Services or this
            ...
            <div className="mt-60">
              ...
              <p>
                In the event of a dispute, you or Answergenie must give the
            ...
            <div className="mt-60">
              ...
              <p>
                If you and Answergenie don’t resolve any dispute by informal
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                property of Answergenie without any compensation or credit to
                you whatsoever. Answergenie and its affiliates shall have no
            ...
            <div className="mt-60">
              <h3>Promotions</h3>
              <p>
                Answergenie may, from time to time, include contests,
            ...
            <div className="mt-60">
              ...
              <p>
                ...
                and signed by an authorized representative of Answergenie.
                Answergenie will be entitled to injunctive or other equitable
                relief (without the obligations of posting any bond or surety)
                in the event of any breach or anticipatory breach by you.
                Answergenie operates and controls the Answergenie Service from
                its offices in Netherlands. The Service is not intended for
                distribution to or use by any person or entity in any
                jurisdiction or country where such distribution or use would be
                contrary to law or regulation. Accordingly, those persons who
                choose to access the Answergenie Service from other locations do
                so on their own initiative and are solely responsible for
                compliance with local laws, if and to the extent local laws are
                applicable. These Terms & Conditions (which include and
                incorporate the Answergenie Privacy Policy) contains the entire
                understanding, and supersedes all prior understandings, between
                you and Answergenie concerning its subject matter, and cannot be
            ...
            <div className="mt-60">
              <h3>Disclaimer</h3>
              <p>
                Answergenie is not responsible for any content, code or any
                other imprecision.
              </p>
              <p>Answergenie does not provide warranties or guarantees.</p>
              <p>
                In no event shall Answergenie be liable for any special, direct,
                ...
                Service or the contents of the Service. Answergenie reserves the
                right to make additions, deletions, or modifications to the
                contents on the Service at any time without prior notice.
              </p>
              <p>
                The Answergenie Service and its contents are provided "as is"
                and "as available" without any warranty or representations of
                any kind, whether express or implied. Answergenie is a
                distributor and not a publisher of the content supplied by third
                parties; as such, Answergenie exercises no editorial control
                over such content and makes no warranty or representation as to
                the accuracy, reliability or currency of any information,
                content, service or merchandise provided through or accessible
                via the Answergenie Service. Without limiting the foregoing,
                Answergenie specifically disclaims all warranties and
                representations in any content transmitted on or in connection
                with the Answergenie Service or on sites that may appear as
                links on the Answergenie Service, or in the products provided as
                a part of, or otherwise in connection with, the Answergenie
                Service, including without limitation any warranties of
                merchantability, fitness for a particular purpose or
                non-infringement of third party rights. No oral advice or
                written information given by Answergenie or any of its
                ...
                foregoing, Answergenie does not warrant that the Answergenie
                Service will be uninterrupted, uncorrupted, timely, or
                error-free.
              </p>
            </div>
            <div className="mt-60">
              ...
              <p>
                -Via Email: <a>hello@Answergenie.co</a>
              </p>
            </div>
          </div>
        </div>
