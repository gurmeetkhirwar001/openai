  ...
  return (
    <>
      <div className="main-page-wrapper light-bg" id="home">
        <Seo title="Home" />
        <Header />
        <div className="privacy-policy container mt-150">
          <div>
            ...
            <p>
              ...
              and seriouscode GmbH ("seriouscode GmbH", "we", "us" or "our"). By
              ...
              this Agreement. This Policy does not apply to the practices of
              companies that we do not own or control, or to individuals that we
              do not employ or manage.
            </p>
          </div>
          <div>
            <h3 className="fw-bold">Automatic collection of information</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Collection of personal information</h3>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              directly from you via the Website and Services. However, we may
              also collect Personal Information about you from other sources
              such as social media, emails, etc. Any of the information we
            ...
            <p>
              ...
              object to such processing (by opting out), without having to rely
              on consent or any other of the following legal bases below. In any
          ...
          <div>
            <h3 className="fw-bold">Billing and payments</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Managing information</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Disclosure of information</h3>
            <p>
              ...
              purposes. We will disclose any Personal Information we collect,
              ...
              respond to a government request. In the event we go through a
              business transition, such as a merger or acquisition by another
              company, or sale of all or a portion of its assets, your user
              account, and Personal Information will likely be among the assets
              transferred.
            </p>
          </div>
          <div>
            <h3 className="fw-bold">Retention of information</h3>
            <p>
              Depending on the requested Services or as necessary to complete We
              will retain and use your Personal Information for the period
          ...
          <div>
            <h3 className="fw-bold">Transfer of information</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">The rights of users</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">The right to object to processing</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Data protection rights under GDPR</h3>
            <p>
              If you are a resident of the European Economic Area (EEA), you
              have certain data protection rights and seriouscode GmbH aims to
              take reasonable steps to allow you to correct, amend, delete, or
              limit the use of your Personal Information. If you wish to be
            ...
            <ul className="ms-4">
              ...
              <li>
                ...
                where seriouscode GmbH relied on your consent to process your
                Personal Information.
              </li>
            </ul>
            <p>
          ...
          <div>
            <h3 className="fw-bold">California privacy rights</h3>
            <p>
              ...
              obtain this information please contact us. Furthermore, California
              ...
              monetary or other valuable consideration. To do so, please visit
              our Do Not Sell page or simply contact us.
            </p>
          </div>
          <div>
            <h3 className="fw-bold">How to exercise these rights</h3>
            <p>
              Any requests to exercise your rights can be directed to
              seriouscode GmbH through the contact details provided in this
          ...
          <div>
            <h3 className="fw-bold">Privacy of children</h3>
            <p>
              ...
              have reason to believe that a child under the age of 18 has
          ...
          <div>
            ...
            <p>
              ...
              operate the Website and Services. You have the ability to accept
              ...
              you may not be able to fully experience the features of the
              Website and Services. To learn more about cookies and how to
              manage them, visitinternetcookies.org
            </p>
          </div>
          <div>
            <h3 className="fw-bold">Do Not Track signals</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Advertisements</h3>
            <p>
              ...
              advertisers collect through your use of the Website and Services.
              We do not share personally identifiable information about
              individual customers with advertisers. In some instances, we may
              use this aggregated and non-identifying information to deliver
              tailored advertisements to the intended audience. We may also
              permit certain third party companies to help us tailor advertising
              that we think may be of interest to users and to collect and use
              other data about user activities on the Website. These companies
              may deliver ads that might place cookies and otherwise track user
              behavior.
            </p>
          </div>
          <div>
          ...
          <div>
            <h3 className="fw-bold">Email marketing</h3>
            <p>
              ...
              clear information on how to contact the sender. You may choose to
          ...
          <div>
            <h3 className="fw-bold">Links to other resources</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Information security</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Data breach</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Changes and amendments</h3>
            <p>
              ...
              treat Personal Information. When we do, we will send you an email
              to notify you. We may also provide notice to you in other ways in
              our discretion, such as through contact information you have
          ...
          <div>
            <h3 className="fw-bold">Acceptance of this policy</h3>
            <p>
          ...
          <div>
            <h3 className="fw-bold">Contacting us</h3>
            <p>
